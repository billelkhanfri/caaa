      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-24 text-center lg:text-left lg:flex lg:items-center lg:justify-between">
        ...
        <div className="lg:w-1/2">
          <h1 className="text-4xl md:text-5xl font-extrabold mb-6">
           ...
           Bienvenue  {/* Bienvenue sur <span className="text-yellow-400"><span className="text-[rgb(0,50,249)]">C</span>AAA</span> */}
          </h1>
          <div className="flex justify-center lg:justify-start">
                <p className=" text-xl font-light mb-6 text-gray-200 max-w-xl leading-relaxed">
            Le CAAA-Coeur de Ville-UDV est une association de bénévoles, active depuis 1972 dans le centre-ville de Toulon.<br></br> Notre mission : l’alphabétisation, l’apprentissage du Français Langue Étrangère et l’accompagnement à la scolarité des enfants. Découvrez notre action et rejoignez-nous pour soutenir nos projets.
          </p>
</div>
